...
--
-- Hôte : localhost:8889
-- Généré le : jeu. 06 nov. 2025 à 15:30
...
--
-- Base de données : `lesecolesalbaraime`
--
...
CREATE TABLE `activites` (
  ...
  `alt_image1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alt_image2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alt_image3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `apropos` (
  ...
  `title_service1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `text_service1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_service2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `text_service2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Structure de la table `controles_continus`
--

CREATE TABLE `controles_continus` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `title_btn` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `controles_continus`
--

INSERT INTO `controles_continus` (`id`, `title`, `semestre_id`, `niveau_id`, `matiere_id`, `ordre`, `file`, `title_btn`, `created_at`, `updated_at`) VALUES
(1, 'Évaluation - Les Couleurs et les Formes', 1, 1, 4, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(2, 'Contrôle - Reconnaissance des Lettres', 1, 2, 1, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(3, 'Test - Les Chiffres de 1 à 10', 1, 3, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(4, 'Contrôle N°1 - La Lecture et l\'Écriture', 1, 4, 1, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(5, 'Contrôle N°1 - Addition et Soustraction', 1, 4, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(6, 'Contrôle N°2 - Grammaire et Orthographe', 1, 5, 1, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(7, 'Contrôle N°1 - Multiplication et Division', 1, 6, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(8, 'Contrôle N°1 - Les États de la Matière', 1, 7, 4, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(9, 'Contrôle N°2 - La Conjugaison', 1, 8, 1, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(10, 'Contrôle N°1 - Fractions et Décimaux', 1, 9, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(11, 'Contrôle N°1 - Géographie du Maroc', 1, 9, 6, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(12, 'Contrôle N°1 - Les Nombres Relatifs', 1, 10, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(13, 'Contrôle N°1 - Grammaire Anglaise', 1, 10, 9, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(14, 'Contrôle N°2 - Les Équations', 1, 11, 3, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(15, 'Contrôle N°1 - États Physiques de la Matière', 1, 11, 7, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(16, 'Contrôle N°1 - Le Corps Humain', 1, 12, 8, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(17, 'Contrôle N°2 - Théorème de Pythagore', 1, 12, 3, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(18, 'Contrôle N°1 - Calcul Numérique', 1, 13, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(19, 'Contrôle N°1 - Introduction à l\'Informatique', 1, 13, 11, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(20, 'Contrôle N°1 - Fonctions Numériques', 1, 14, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(21, 'Contrôle N°2 - Dérivation', 1, 14, 3, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(22, 'Contrôle N°1 - Mécanique', 1, 14, 7, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(23, 'Contrôle N°1 - Les Suites Numériques', 1, 15, 3, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(24, 'Contrôle N°2 - Limites et Continuité', 1, 15, 3, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(25, 'Contrôle N°1 - La Philosophie et la Pensée', 1, 15, 10, 1, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(26, 'Contrôle N°3 - Géométrie', 2, 8, 3, 3, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(27, 'Contrôle N°2 - La Cellule Vivante', 2, 12, 8, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(28, 'Contrôle N°3 - Intégration', 2, 14, 3, 3, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(29, 'Examen Final - Électricité', 2, 15, 7, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(30, 'Contrôle N°2 - Éthique et Morale', 2, 15, 10, 2, 'controles-continus/sample.pdf', 'Télécharger', '2025-11-06 13:52:39', '2025-11-06 13:52:39');
...
CREATE TABLE `fournitures` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `niveau` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `file` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_btn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `homes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `second_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `image1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alt_image1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `matieres` (`id`, `title`, `created_at`, `updated_at`) VALUES
(1, 'Langue Française', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(2, 'Langue Arabe', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(3, 'Mathématiques', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(4, 'Éveil Scientifique', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(5, 'Éducation Islamique', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(6, 'Histoire-Géographie', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(7, 'Physique-Chimie', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(8, 'Sciences de la Vie et de la Terre', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(9, 'Anglais', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(10, 'Philosophie', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(11, 'Informatique', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(12, 'Éducation Physique', '2025-11-06 13:52:39', '2025-11-06 13:52:39');
...
(43, '2025_11_06_012806_create_niveaus_table', 10),
(44, '2025_11_06_012809_create_matieres_table', 11),
(46, '2025_11_06_020006_create_semestres_table', 13),
(47, '2025_11_06_012826_create_controles_continus_table', 14);
...
INSERT INTO `niveaus` (`id`, `title`, `created_at`, `updated_at`) VALUES
(1, 'Petite Section', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(2, 'Moyenne Section', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(3, 'Grande Section', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(4, '1ère Année Primaire', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(5, '2ème Année Primaire', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(6, '3ème Année Primaire', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(7, '4ème Année Primaire', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(8, '5ème Année Primaire', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(9, '6ème Année Primaire', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(10, '1ère Année Collège', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(11, '2ème Année Collège', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(12, '3ème Année Collège', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(13, 'Tronc Commun', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(14, '1ère Année Bac', '2025-11-06 13:52:39', '2025-11-06 13:52:39'),
(15, '2ème Année Bac', '2025-11-06 13:52:39', '2025-11-06 13:52:39');
...
CREATE TABLE `programmes` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `programme1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `programme2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `programme3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `programme4` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `programme5` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `programme6` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `semestres` (`id`, `title`, `created_at`, `updated_at`) VALUES
(1, 'Semestre 1', '2025-11-06 01:16:45', '2025-11-06 01:16:45'),
(2, 'Semestre 2', '2025-11-06 01:16:52', '2025-11-06 01:16:52'),
(3, 'Semestre 3', '2025-11-06 13:32:12', '2025-11-06 13:32:12');
...
CREATE TABLE `settings` (
  ...
  `adresse1` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse1_map` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse2` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse2_map` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `temoignages` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `temoignage1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom1` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `temoignage2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom2` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `temoignage3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom3` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `temoignage4` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom4` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar_1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar_2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar_3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar_4` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Index pour la table `controles_continus`
--
ALTER TABLE `controles_continus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `controles_continus_semestre_id_foreign` (`semestre_id`),
  ADD KEY `controles_continus_niveau_id_foreign` (`niveau_id`),
  ADD KEY `controles_continus_matiere_id_foreign` (`matiere_id`);
...
--
-- AUTO_INCREMENT pour la table `controles_continus`
--
ALTER TABLE `controles_continus`
...
--
-- Contraintes pour la table `controles_continus`
--
ALTER TABLE `controles_continus`
  ADD CONSTRAINT `controles_continus_matiere_id_foreign` FOREIGN KEY (`matiere_id`) REFERENCES `matieres` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `controles_continus_niveau_id_foreign` FOREIGN KEY (`niveau_id`) REFERENCES `niveaus` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `controles_continus_semestre_id_foreign` FOREIGN KEY (`semestre_id`) REFERENCES `niveaus` (`id`) ON DELETE CASCADE;
COMMIT;
