...
<!-- campus tour -->
<div class="campus-tour pt-120 pb-10">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                    <div class="site-heading mb-3">
                        <span class="site-title-tagline"><i class="far fa-book-open-reader"></i>  {{ $lycee->niveau }} </span>
                        <h2 class="site-title">
                            {{ $lycee->title }} 
                        </h2>
                    </div>
                    <p class="content-text">
                        {!! str($lycee->description)->sanitizeHtml() !!}
                    </p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="content-img wow fadeInRight" data-wow-delay=".25s">
                    <img src="{{ asset('storage/'.$lycee->image) }}" alt="{{ $lycee->alt_image }}">
                </div>
            </div>
        </div>
    </div>
