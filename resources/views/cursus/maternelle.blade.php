...
@section('content')
    ...
    <main class="main">
        ...
        <!-- how apply -->
        <div class="how-apply pt-120 pb-10">
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <p class="content-text">
                                {!! str($maternelle->description)->sanitizeHtml() !!}                                 
                            </p> 
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="content-img wow fadeInRight" data-wow-delay=".25s"> 
                            <img src="{{ asset('storage/'.$maternelle->image) }}" alt="{{ $maternelle->alt_image }}">
                        </div>
                    </div>
                </div>
            </div>
