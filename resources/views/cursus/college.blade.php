...
<!-- alumni -->
<div class="alumni pt-120 pb-10">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="content-img wow fadeInLeft" data-wow-delay=".25s">
                    <img src="{{ asset('storage/'.$college->image) }}" alt="{{ $college->alt_image }}">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                    <div class="site-heading mb-3">
                        <span class="site-title-tagline"><i class="far fa-book-open-reader"></i>{{ $college->niveau }}</span>
                        <h2 class="site-title">
                            {{ $college->title }} 
                        </h2>
                    </div>
                    <p class="content-text">
                         {!! str($college->description)->sanitizeHtml() !!}
                    </p> 
                </div>
            </div>
        </div>
