...
use App\Filament\Resources\PrimaireResource\Pages;
use App\Filament\Resources\PrimaireResource\RelationManagers;
...
class PrimaireResource extends Resource
{
    protected static ?string $model = Primaire::class;

    protected static ?string $navigationIcon = 'uni-bus-school-o';

    protected static ?string $navigationGroup = 'Cursus Scolaire page';

    protected static ?string $navigationLabel = 'Primaire';
    ...
    public static function form(Form $form): Form
    {
        ...
        ->schema([
            Group::make()
            ->schema([
                Section::make('Informations du page Primaire')
            ...
            Group::make()
            ->schema([
                Section::make('Images du page Primaire')
    ...
    {
        return [
            'index' => Pages\ListPrimaires::route('/'),
            'create' => Pages\CreatePrimaire::route('/create'),
            'edit' => Pages\EditPrimaire::route('/{record}/edit'),
        ];
    }
}
