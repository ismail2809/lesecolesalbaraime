...
class CafeteriaResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Caféteria'; 
    ...
    {
        return [
            'index' => Pages\ListCafeterias::route('/'),
            'create' => Pages\CreateCafeteria::route('/create'),
            'edit' => Pages\EditCafeteria::route('/{record}/edit'),
        ];
    }
}
